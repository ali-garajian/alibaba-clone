...
import ComboBox, { ComboEntry, IComboBoxProps } from '../ComboBox'
...
function FormComboBox(props: FormComboBoxProps, ref: React.Ref<unknown>) {
...
export default React.forwardRef(FormComboBox)
